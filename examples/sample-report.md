...
_Audited 2026-09-05T15:20:54Z · profile balanced · 12 page(s) crawled_
...
- 🟢 Heading hierarchy skips levels (low, medium effort)
- 🟢 Meta descriptions likely to be truncated (low, medium effort)
- 🟢 Substantial content offloaded to PDF files (low, low effort)
- 🟢 Title tags outside the useful length range (low, medium effort)
...
- **Evidence:** 2 of 12 page(s) (17%) took over 3s to return HTML (e.g. https://www.smashingmagazine.com/category/wallpapers/: 31380 ms).
...
- **Affected pages:** https://www.smashingmagazine.com/ebook-bundles/content-strategy-ebook-bundle-3-ebooks/, https://www.smashingmagazine.com/category/wallpapers/
...
- **Evidence:** 11 of 12 page(s) (92%) jump heading levels (e.g. H1→H3 with no H2), e.g. https://www.smashingmagazine.com/.
...
---
_Generated by brand-ai-readiness-audit · brand-ai-readiness-audit/2.2 · read-only, recommend-only. JSON is the canonical output._