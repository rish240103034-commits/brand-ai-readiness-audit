...
_Audited 2026-09-06T11:06:03Z · profile balanced · 12 page(s) crawled_
...
- **Evidence:** 2 of 12 page(s) (17%) took over 3s to return HTML in this run (e.g. https://www.smashingmagazine.com/ebook-bundles/web-design-ebook-bundle-10-ebooks/: 47534 ms). Single-sample timing — confirm with a repeat measurement.
- **Fix (medium):** Investigate TTFB (caching, CDN, server work); confirm the slowness is consistent before prioritizing.
- **Affected pages:** https://www.smashingmagazine.com/ebook-bundles/ux-ebook-bundle-12-ebooks/, https://www.smashingmagazine.com/ebook-bundles/web-design-ebook-bundle-10-ebooks/
...
---
_Generated by brand-ai-readiness-audit · brand-ai-readiness-audit/2.6 · read-only, recommend-only. JSON is the canonical output._