#!/usr/bin/env python3
"""Standalone runner for engagement-audit (on-site engagement / bounce factors). Read-only."""
...
from auditlib.checks import engagement         # noqa: E402


def main(argv=None) -> int:
    return run_single_skill(
        "engagement-audit", [engagement.analyze],
        description="On-site engagement audit for one site.", argv=argv)
